...
if __name__ == '__main__':
    ...
    train_dataset = DubaiCCDataset(data_folder='/iarai/home/shizhen.chang/Change_Caption/Data/Dubai_CC/RGB',list_path='./data/Dubai_CC/', split= 'train', token_folder=None)
